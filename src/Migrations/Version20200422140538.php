 ...
 */
final class Version20200422140538 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE messages (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, content CLOB DEFAULT NULL, date DATETIME NOT NULL, sender_id INTEGER NOT NULL, chat_id INTEGER NOT NULL, file_id INTEGER DEFAULT NULL)');
