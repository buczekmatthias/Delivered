 ...
 */
final class Version20201217112024 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE chats ADD COLUMN name VARCHAR(300) DEFAULT NULL');
        $this->addSql('ALTER TABLE chats ADD COLUMN image VARCHAR(1000) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__chats AS SELECT id, members, files FROM chats');
        ...
        $this->addSql('INSERT INTO chats (id, members, files) SELECT id, members, files FROM __temp__chats');
