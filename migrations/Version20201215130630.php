 ...
 */
final class Version20201215130630 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, friends_id, login, roles, password, email, name, city, birthday_date, joined_at, image FROM user');
        ...
        $this->addSql('INSERT INTO user (id, friends_id, login, roles, password, email, name, city, birthday_date, joined_at, image) SELECT id, friends_id, login, roles, password, email, name, city, birthday_date, joined_at, image FROM __temp__user');
